...
//   const network = Network.SONIC_TESTNET;
...
//   const maxLeverage = 40; // Increased from 10 to 50
...
//         const currentMarginAccount = await sdk.getMarginAccount(keypair.publicKey);
