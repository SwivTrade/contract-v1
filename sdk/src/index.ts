...
export const NETWORK_CONFIGS: Record<Network, NetworkConfig> = {
  [Network.SONIC_TESTNET]: {
    ...
    contractsProgramId: '9wdJq5R7VUuXDrAZBnXfDqc1vW6nwAW5aYneMKiryppz',
    mockOracleProgramId: 'F7r5C99gqsAXgsFJjKQD2KuEGVXgsXaYJgG9nn43cdfk'
  },
  ...
  [Network.LOCALNET]: {
    ...
    contractsProgramId: '2nga8op3u3j7Df7wsQv2n5hkRqjEFLjkWGGAfn4cHsfy',
    mockOracleProgramId: 'G2EDsqC3igU7f1PgvZgTSLdAMTn9qmwEq7y8Z92hFTCH'
  }
};
...
export class PerpetualSwapSDK {
  ...
  async buildUpdateMarketParamsTransaction(
    params: {
      market: PublicKey;
    ...
    const tx = await this.program.methods
      .updateMarketParams(
        params.maintenanceMarginRatio ? new BN(params.maintenanceMarginRatio) : null,
        params.initialMarginRatio ? new BN(params.initialMarginRatio) : null,
        params.fundingInterval ? new BN(params.fundingInterval) : null,
        params.maxLeverage ? new BN(params.maxLeverage) : null
      )
      .accountsStrict({
        market: params.market,
        authority,
